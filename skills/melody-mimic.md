...
| 风格类型 | {原曲风格} | {新作风格} | {✅/⚠️/❌} |
| 情感基调 | {原曲情感} | {新作情感} | {✅/⚠️/❌} |
| 意象密度 | {原曲意象数/段} | {新作意象数/段} | {✅/⚠️/❌} |
| 修辞手法 | {原曲主要手法} | {新作主要手法} | {✅/⚠️/❌} |
...
├── {new-song-name}.txt           # 新歌词文件
├── {new-song-name}.jianpu        # 简谱文件（如有）
├── {new-song-name}.mid           # MIDI 文件（如有）
└── {new-song-name}-创作报告.md   # 本报告
```
